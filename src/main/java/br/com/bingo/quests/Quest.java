...
public enum Quest {
    ...
    COLLECT_CHAIN(QuestType.COLLECT_ITEM, Material.CHAIN, Material.CHAIN, "Colete uma Corrente", 1),
    ...
    COLLECT_CHAIN_FULL_SET(QuestType.FULL_SET, Material.CHAIN, Material.CHAINMAIL_CHESTPLATE, "Colete um Set Completo de Cota de Malha \n e coloque ele em um Armor Stand", 4),
