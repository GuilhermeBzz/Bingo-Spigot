...
public enum Quest {
    ...
    KILL_SNOWMAN(QuestType.KILL_MOB, EntityType.SNOW_GOLEM, EntityHead.SNOWMAN,"Mate um Snowman", 2),
    ...
    WARDEN_SUMMON(QuestType.SPAWN, EntityType.WARDEN, EntityHead.WARDEN,"Spawne o Warden", 3),
    ...
    KILL_PLAYER(QuestType.KILL_PLAYER, "Nada", EntityHead.STEVE,"Mate um Jogador de outro time", 4),
    ...
    COLLECT_HEART_OF_THE_SEA(QuestType.COLLECT_ITEM, Material.HEART_OF_THE_SEA, Material.HEART_OF_THE_SEA, "Pegue um Coração do Mar", 2),
    ...
    COLLECT_COPPER_TRAP_DOR(QuestType.COLLECT_ITEM, Material.COPPER_TRAPDOOR, Material.COPPER_TRAPDOOR, "Colete um alçapão de Cobre", 1),
    COLLECT_AUTO_CRAFT(QuestType.COLLECT_ITEM, Material.CRAFTER, Material.CRAFTER, "Colete um Crafter", 2),
    COLLECT_TUFO_ESCADA(QuestType.COLLECT_ITEM, Material.TUFF_STAIRS, Material.TUFF_STAIRS, "Colete uma Escada de Tufo",1),
    COLLECT_COPPER_GRATE(QuestType.COLLECT_ITEM, Material.COPPER_GRATE, Material.COPPER_GRATE, "Colete uma Grade de Cobre", 2),
    COLLECT_MACE(QuestType.COLLECT_ITEM, Material.MACE, Material.MACE, "Colete uma Clava", 3),
    ADV_REV_IND(QuestType.ADVANCEMENT, "Crafters Crafting Crafters", Material.CRAFTER, "Veja um Crafter criando um Crafter", 2),
    ADV_TRIAL(QuestType.ADVANCEMENT, "Minecraft: Trial(s) Edition", Material.CHISELED_TUFF, "Entre numa câmara do desafio", 2),
    KILL_ARMADILLO(QuestType.KILL_MOB, EntityType.ARMADILLO, EntityHead.ARMADILLO, "Mate um Tatu", 1),
    COLLECT_BUNDLE(QuestType.COLLECT_ITEM, Material.BUNDLE, Material.BUNDLE, "Colete uma Trouxa", 1),
    COLLECT_RESIGN_BRICK(QuestType.COLLECT_ITEM, Material.RESIN_BRICK, Material.RESIN_BRICK, "Colete um Tijolo de Resina", 2),
    COLLECT_PALE_BOAT(QuestType.COLLECT_ITEM, Material.PALE_OAK_BOAT, Material.PALE_OAK_BOAT, "Colete um Barco de Carvalho Pálido", 2),
    COLLECT_PALE_LEAVE(QuestType.COLLECT_ITEM, Material.PALE_OAK_LEAVES, Material.PALE_OAK_LEAVES, "Colete Folhas de Carvalho Pálido",2),
    COLLECT_DOG_ARMOR(QuestType.COLLECT_ITEM, Material.WOLF_ARMOR, Material.WOLF_ARMOR, "Colete uma Armadura de Lobo", 2),
    TAME_HORSE(QuestType.TAME_MOB, EntityType.HORSE, EntityHead.HORSE, "Domestique um Cavalo", 2),
    TAME_LLAMA(QuestType.TAME_MOB, EntityType.LLAMA, EntityHead.LLAMA, "Domestique uma Lhama", 2),
    COLLECT_GOAT_HORN(QuestType.COLLECT_ITEM, Material.GOAT_HORN, Material.GOAT_HORN, "Colete um Chifre de Bode", 3),
    COLLECT_GLOW_LICHEN(QuestType.COLLECT_ITEM, Material.GLOW_LICHEN, Material.GLOW_LICHEN, "Colete um Líquen Brilhante", 2),
    COLLECT_CHISELED_SANDSTONE(QuestType.COLLECT_ITEM, Material.CHISELED_SANDSTONE, Material.CHISELED_SANDSTONE, "Colete um Arenito Entalhado", 1),
    COLLECT_DIAMOND_HOE(QuestType.COLLECT_ITEM, Material.DIAMOND_HOE, Material.DIAMOND_HOE, "Colete uma Enxada de Diamante", 1),
    COLLECT_MINECART_WITH_CHEST(QuestType.COLLECT_ITEM, Material.CHEST_MINECART, Material.CHEST_MINECART, "Colete um Vagão com Baú", 2),
    COLLECT_TRIDENT(QuestType.COLLECT_ITEM, Material.TRIDENT, Material.TRIDENT, "Colete um Tridente", 3),
    COLLECT_CHAIN(QuestType.COLLECT_ITEM, Material.IRON_CHAIN, Material.IRON_CHAIN, "Colete uma Corrente", 1),
    COLLECT_CROSBOW(QuestType.COLLECT_ITEM, Material.CROSSBOW, Material.CROSSBOW, "Colete uma Besta", 1),
    COLLECT_BROWN_MUSHROOM(QuestType.COLLECT_ITEM, Material.BROWN_MUSHROOM, Material.BROWN_MUSHROOM, "Colete um Cogumelo Marrom", 1),
    COLLECT_RED_MUSHROOM(QuestType.COLLECT_ITEM, Material.RED_MUSHROOM, Material.RED_MUSHROOM, "Colete um Cogumelo Vermelho", 1),
    COLLECT_MUSHROOM_STEW(QuestType.COLLECT_ITEM, Material.MUSHROOM_STEW, Material.MUSHROOM_STEW, "Colete um Ensopado de Cogumelo", 2),
    COLLECT_CAULDRON(QuestType.COLLECT_ITEM, Material.CAULDRON, Material.CAULDRON, "Colete um Caldeirão", 2),
    COLLECT_COCOA_BEANS(QuestType.COLLECT_ITEM, Material.COCOA_BEANS, Material.COCOA_BEANS, "Colete um Cocoa Bean", 2),
    COLLECT_SPORE_BLOSSOM(QuestType.COLLECT_ITEM, Material.SPORE_BLOSSOM, Material.SPORE_BLOSSOM, "Colete um Spore Blossom", 2),
    COLLECT_SUGAR(QuestType.COLLECT_ITEM, Material.SUGAR, Material.SUGAR, "Colete um Açúcar", 1),
    COLLECT_SUSPICIOUS_STEW(QuestType.COLLECT_ITEM, Material.SUSPICIOUS_STEW, Material.SUSPICIOUS_STEW, "Colete um Ensopado Suspeito", 2),
    COLLECT_BEETROOT_SOUP(QuestType.COLLECT_ITEM, Material.BEETROOT_SOUP, Material.BEETROOT_SOUP, "Colete um Ensopado de Beterraba", 2),
    SPAWN_ALLAY_DUPLICATION(QuestType.SPAWN, EntityType.ALLAY, EntityHead.ALLAY, "Duplique um Allay", 3),
    KILL_FOX(QuestType.KILL_MOB, EntityType.FOX, EntityHead.FOX, "Mate uma Raposa", 1),
    KILL_GOAT(QuestType.KILL_MOB, EntityType.GOAT, EntityHead.GOAT, "Mate um Bode", 2),
    BREED_RABBIT(QuestType.BREED_MOB, EntityType.RABBIT, EntityHead.RABBIT, "Reproduza Coelhos", 2),
    COLLECT_BONSAI_POT(QuestType.COLLECT_ITEM, Material.FLOWER_POT, Material.FLOWER_POT, "Colete um Vaso", 1),
    COLLECT_BAMBOO_BLOCK(QuestType.COLLECT_ITEM, Material.BAMBOO_BLOCK, Material.BAMBOO_BLOCK, "Colete um Bloco de Bambu", 2),
    TAME_PARROT(QuestType.TAME_MOB, EntityType.PARROT, EntityHead.PARROT, "Domestique um Papagaio", 2),
    COLLECT_MOSS_BLOCK(QuestType.COLLECT_ITEM, Material.MOSS_BLOCK, Material.MOSS_BLOCK, "Colete um Bloco de Musgo", 1),
    BREED_AXOLOTL(QuestType.BREED_MOB, EntityType.AXOLOTL, EntityHead.AXOLOTL, "Reproduza Axolotls", 3),
    COLLECT_HANGING_SIGN(QuestType.COLLECT_ITEM, Material.OAK_HANGING_SIGN, Material.OAK_HANGING_SIGN, "Colete uma Placa Suspensa de Carvalho", 1),
    COLLECT_TINTED_GLASS(QuestType.COLLECT_ITEM, Material.TINTED_GLASS, Material.TINTED_GLASS, "Colete um Vidro Tingido", 2),
    TAME_CAT(QuestType.TAME_MOB, EntityType.CAT, EntityHead.CAT, "Domestique um Gato", 2),
    COLLECT_DECORATED_POT(QuestType.COLLECT_ITEM, Material.DECORATED_POT, Material.DECORATED_POT, "Colete um Pote Decorado", 4),
    EFFECT_ABSORPTION(QuestType.GET_EFFECT, PotionEffectType.ABSORPTION, EntityHead.ABSORPTION, "Consiga o Efeito de Absorção", 2),
    COLLECT_CHERRY_BOAT(QuestType.COLLECT_ITEM, Material.CHERRY_BOAT, Material.CHERRY_BOAT, "Colete um Barco de Cerejeira", 2),
    DYE_SHEEP(QuestType.DYE, EntityType.SHEEP, Material.YELLOW_DYE, "Tinja uma Ovelha de qualquer cor", 1),
    COLLECT_CAMPFIRE(QuestType.COLLECT_ITEM, Material.CAMPFIRE, Material.CAMPFIRE, "Colete uma Fogueira", 1),
    ...
    COLLECT_CHAIN_CHESTPLATE(QuestType.COLLECT_ITEM, Material.CHAINMAIL_CHESTPLATE, Material.CHAINMAIL_CHESTPLATE, "Colete um Peitoral de Corrente", 2),
    COLLECT_DIAMOND_FULL_SET(QuestType.FULL_SET, Material.DIAMOND, Material.DIAMOND_CHESTPLATE, "Colete um Set Completo de Diamante \n e coloque ele em um Armor Stand", 4),
    COLLECT_GOLDEN_FULL_SET(QuestType.FULL_SET, Material.GOLD_INGOT, Material.GOLDEN_CHESTPLATE, "Colete um Set Completo de Ouro \n e coloque ele em um Armor Stand", 4),
    COLLECT_IRON_FULL_SET(QuestType.FULL_SET, Material.IRON_INGOT, Material.IRON_CHESTPLATE, "Colete um Set Completo de Ferro \n e coloque ele em um Armor Stand", 4),
    COLLECT_LEATHER_FULL_SET(QuestType.FULL_SET, Material.LEATHER, Material.LEATHER_CHESTPLATE, "Colete um Set Completo de Couro \n e coloque ele em um Armor Stand", 4),
    COLLECT_CHAIN_FULL_SET(QuestType.FULL_SET, Material.IRON_CHAIN, Material.CHAINMAIL_CHESTPLATE, "Colete um Set Completo de Cota de Malha \n e coloque ele em um Armor Stand", 4),
    ...
    COLLECT_LODSTONE(QuestType.COLLECT_ITEM, Material.LODESTONE, Material.LODESTONE, "Colete um Lodstone", 2),
